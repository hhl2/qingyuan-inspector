...
export const MOCK_GCGW_DATA = [{
    ...
    detectDayCount: 200,
    innovativeDesign: '',
    // innovativeDesign: "实现对10kV避雷器工频参考电压试验、直流参考电压试验局部放电试验、0.75倍直流参考电压下泄露电流试验、持电流试验、密封试验，具备在预处理区完成外观检查、统爬电比距检查，对12支避雷器一次接线，一键启动测量。除预处理可人工辅助外，其他检测自动完成，无需人工参与,实现对10kV避雷器工频参考电压试验、直流参考电压试验局部放电试验、0.75倍直流参考电压下泄露电流试验、持电流试验、密封试验，具备在预处理区完成外观检查、统爬电比距检查，对12支避雷器一次接线，一键启动测量。除预处理可人工辅助外，其他检测自动完成，无需人工参与",
